...
void S01Main::init()
{
	...
	m_Princess.load("Resources/view.obj", ""); 
	...
	//}
	m_Object[0].setModel(&m_Princess);
	m_Object[0].setPosition(0.f - 200.f, 20.f - 200.f, 0.f);
	m_Object[1].setModel(&m_Princess);
	m_Object[1].setPosition(400.f - 200.f, 370.f - 200.f, 0.f);
}
...
void S01Main::render()
{
	...
	for (size_t i = 0; i < 10; ++i)
	{
		m_Object[i].setColor(Vector3(0.5f,0.7f * i,0.2f));
		m_Object[i].render();
	}
}
...
{
	m_Object[0].rotate(0.01f, Vector3(0.f, 0.f, 1.f));
	m_Object[1].rotate(-0.01f, Vector3(0.f, 0.f, 1.f));
}